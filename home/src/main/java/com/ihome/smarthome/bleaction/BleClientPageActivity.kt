...
import com.ihome.smarthome.bleaction.adapter.BleConnectionAdapter
...
class BleClientPageActivity: FragmentActivity() {
    ...
    private inner class daqiBleConnectionListener: BleConnectionHelper.BleConnectionListener {
        override fun onConnectionSuccess() {
            ...
            BleToastUtils.showBottomToast(this@BleClientPageActivity,"连接成功")
        }

        override fun onConnectionFail() {
            connectionBtn.isEnabled = true
            BleToastUtils.showBottomToast(this@BleClientPageActivity,"连接失败")
        }
        ...
        override fun disConnection() {
            ...
            BleToastUtils.showBottomToast(this@BleClientPageActivity,"断开连接")
        }
        ...
        override fun discoveredServices() {
            ...
            //刷新列表
            mAdapter.notifyDataSetChanged()
            BleToastUtils.showBottomToast(this@BleClientPageActivity,"发现服务")
        }

        override fun readCharacteristic(data: String) {
            BleToastUtils.showBottomToast(this@BleClientPageActivity,data)
        }
