package com.ihome.smarthome.bleaction.adapter
...
import com.ihome.smarthome.bleaction.BleToastUtils
import com.ihome.smarthome.bleaction.BluetoothUtils.hexStringToBytes
import com.ihome.smarthome.bleaction.mGattServiceList
        ...
        private fun addCharacteristicLayout(characteristic:BluetoothGattCharacteristic){
            ...
            characteristic.descriptors?.let {descriptors ->
                ...
                for (descriptor in descriptors) {
                    ...
                    //描述uuid
                    val descriptorUUID:TextView = descriptorView.findViewById( R.id.descriptorUUID)
                    //描述读取按钮
                    val readDescriptorBtn:ImageView = descriptorView.findViewById( R.id.readBtn)
                    //描述写入按钮
                    val writeDescriptorBtn:ImageView = descriptorView.findViewById( R.id.writeBtn)
                    //设置描述值
        ...
        private fun showWriteDialog(characteristic:BluetoothGattCharacteristic){
            ...
            positiveBtn.setOnClickListener {
                ...
                if (Pattern.matches("^[A-Fa-f0-9]+\$", dataStr)){
                    ...
                    BleToastUtils.showBottomToast(mContext,"$dataStr 不是十六进制")
                }
            }
        }
